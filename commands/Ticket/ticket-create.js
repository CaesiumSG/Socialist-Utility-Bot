...
module.exports.run = async (client, message, args) => {
  ...
  .setColor('#e64b0e')
  .setDescription(`Gimmie Me Perm: Manage Channels nab`)
  ...
  .setColor('#e64b0e')
  .setDescription(`You already have a ticket open, close that one first nab`)
  ...
  .setColor('#e64b0e')
  .setDescription(`Ticket Cancelled, make an informed choice first nab smh`)

  let timeoutembed = new Discord.MessageEmbed()
  .setColor('#e64b0e')
  .setDescription(`Time expired, make a choice quicker nub`)

  let input = new Discord.MessageEmbed()
  .setColor('#e64b0e')
  .setDescription(`Please choose from one of the following ticket topics: \n\n1: ${topic1}\n2: ${topic2}\n3: ${topic3}\n4: ${topic4}\n5: ${topic5}`)
  .setFooter(`This will expire in 10 seconds then you will be put on a 5 minute cooldown for wasting my time`)
